...
from ddpm.diffusion import Inferencer
from inference.get_dataset import get_dataset
...
breakpoint()
test_dataset, _ = get_dataset(cfg)
breakpoint()
...
if cfg.model.load_milestone:
    inferencer.load(cfg.model.load_milestone, map_location='cuda:' + str(cfg.model.gpus))
