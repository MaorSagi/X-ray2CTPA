...
UNET_DEFAULT_TARGET_REPLACE = {"ResnetBlock", "SpatialLinearAttention", "Attention", "Block"}
UNET_EXTENDED_TARGET_REPLACE = {"ResnetBlock", "SpatialLinearAttention", "Attention", "Block"}
